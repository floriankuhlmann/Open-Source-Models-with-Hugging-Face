...
if __name__ == "__main__":
    ...
    if args.model == "blenderbot":
        ...
        save_directory = "models/facebook/blenderbot-400M-distill"
    elif args.model == "nllb200":
        model_name = "facebook/nllb-200-distilled-600M"
        save_directory = "models/facebook/nllb-200-distilled-600M"
    elif args.model == "bart":
        model_name = "facebook/bart-large-cnn"
        save_directory = "models/facebook/bart-large-cnn"
    elif args.model == "ashraqesc50":
        model_name = "tashraq/esc50/train"
        save_directory = "models/ashraq/esc50/train"
    else:
